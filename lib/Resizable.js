...
export default class Resizable extends React.Component {
    ...
    renderResizeHandle = () => {
        if (this.props.isActive) {
            return this.props.allResizeHandle ? this.renderAllResizeHandles() : this.renderOneResizeHandle()
        }
        return null
    }
    ...
    onResizeStop = (event, {node}) => {
        ...
        this.setState(this.onResizeStopState(),
            () => this.resizeStopCallback(event, node, this.toDimension(this.state)))
    }
